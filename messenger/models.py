...
class Thread(models.Model):
	users= models.ManyToManyField(Egresado, related_name= 'threads')
...
def message_changed(sender, **kwargs):
	...
	#Borrar los mensajes de false_pk_set que si estan en pk_set y los borramos de pk_set
	# Forzar la actualización haciendo save
	instance.save()
	pk_set.difference_update(false_pk_set) #restamos los elementos que estan en false_pk de pk_set
